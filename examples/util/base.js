...
const imageClassificationModels = [{
  ...
  modelSize: '102.6MB',
  modelFile: 'https://belem.oss-cn-shanghai.aliyuncs.com/webml/model/ic/resnet50v1.onnx',
  labelsFile: '../image_classification/model/labels1000.txt',
  inputSize: [224, 224, 3],
  outputSize: 1000,
  preOptions: {
  ...
  modelSize: '102.4MB',
  modelFile: 'https://belem.oss-cn-shanghai.aliyuncs.com/webml/model/ic/resnet50v2.onnx',
  labelsFile: '../image_classification/model/labels1000.txt',
  inputSize: [224, 224, 3],
  outputSize: 1000,
  preOptions: {
...
const objectDetectionModels = [{
  ...
  modelSize: '67.3MB',
  modelFile: 'https://belem.oss-cn-shanghai.aliyuncs.com/webml/model/od/ssd_mobilenet_v2.tflite',
  labelsFile: '../object_detection/model/coco_classes.txt',
  type: 'SSD',
  box_size: 4,
  num_classes: 91,
  ...
  modelSize: '63.4MB',
  modelFile: 'https://belem.oss-cn-shanghai.aliyuncs.com/webml/model/od/tiny_yolov2_voc.tflite',
